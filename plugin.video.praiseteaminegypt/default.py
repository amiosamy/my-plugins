# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/praiseteaminegypt
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "praiseteaminegypt"

# Entry point
def run():
    plugintools.log("praiseteaminegypt.run")
...
def main_list(params):
    plugintools.log("praiseteaminegypt.main_list "+repr(params))
