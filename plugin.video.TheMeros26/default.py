# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/TheMeros26
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "TheMeros26"

# Entry point
def run():
    plugintools.log("TheMeros26.run")
...
def main_list(params):
    plugintools.log("TheMeros26.main_list "+repr(params))
