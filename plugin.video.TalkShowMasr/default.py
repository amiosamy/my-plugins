# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/TalkShowMasr
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "TalkShowMasr"

# Entry point
def run():
    plugintools.log("TalkShowMasr.run")
...
def main_list(params):
    plugintools.log("TalkShowMasr.main_list "+repr(params))
