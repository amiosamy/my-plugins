# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/theofficial700club
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "theofficial700club"

# Entry point
def run():
    plugintools.log("theofficial700club.run")
...
def main_list(params):
    plugintools.log("theofficial700club.main_list "+repr(params))
