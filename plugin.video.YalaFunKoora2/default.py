# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/YalaFunKoora2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "YalaFunKoora2"

# Entry point
def run():
    plugintools.log("YalaFunKoora2.run")
...
def main_list(params):
    plugintools.log("YalaFunKoora2.main_list "+repr(params))
