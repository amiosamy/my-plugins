# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/CairoCinemaMovies
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "CairoCinemaMovies"
...
def main_list(params):
    plugintools.log("CairoCinemaMovies.main_list "+repr(params))
