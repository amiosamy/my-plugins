# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/TheBetterLifeTeam
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "TheBetterLifeTeam"
...
def main_list(params):
    plugintools.log("TheBetterLifeTeam.main_list "+repr(params))
