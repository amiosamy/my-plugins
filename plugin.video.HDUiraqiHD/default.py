# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/HDUiraqiHD
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "HDUiraqiHD"

# Entry point
def run():
    plugintools.log("HDUiraqiHD.run")
...
def main_list(params):
    plugintools.log("HDUiraqiHD.main_list "+repr(params))
