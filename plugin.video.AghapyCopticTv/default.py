# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/AghapyCopticTv
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "AghapyCopticTv"

# Entry point
def run():
    plugintools.log("AghapyCopticTv.run")
...
def main_list(params):
    plugintools.log("AghapyCopticTv.main_list "+repr(params))
