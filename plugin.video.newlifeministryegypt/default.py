# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/newlifeministryegypt
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "newlifeministryegypt"

# Entry point
def run():
    plugintools.log("newlifeministryegypt.run")
...
def main_list(params):
    plugintools.log("newlifeministryegypt.main_list "+repr(params))
