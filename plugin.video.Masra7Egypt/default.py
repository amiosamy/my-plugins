# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/Masra7Egypt
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "Masra7Egypt"

# Entry point
def run():
    plugintools.log("Masra7Egypt.run")
...
def main_list(params):
    plugintools.log("Masra7Egypt.main_list "+repr(params))
