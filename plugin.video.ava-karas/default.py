# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/migo2007migo
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "migo2007migo"

# Entry point
def run():
    plugintools.log("migo2007migo.run")
...
def main_list(params):
    plugintools.log("migo2007migo.main_list "+repr(params))
