# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/KharabeeshCartoons
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "KharabeeshCartoons"
...
def main_list(params):
    plugintools.log("KharabeeshCartoons.main_list "+repr(params))
