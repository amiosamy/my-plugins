# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/TheAllNewPopeyeShow
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "TheAllNewPopeyeShow"

# Entry point
def run():
    plugintools.log("TheAllNewPopeyeShow.run")
...
def main_list(params):
    plugintools.log("TheAllNewPopeyeShow.main_list "+repr(params))
