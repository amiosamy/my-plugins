# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/TheFaithTube
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "TheFaithTube"

# Entry point
def run():
    plugintools.log("TheFaithTube.run")
...
def main_list(params):
    plugintools.log("TheFaithTube.main_list "+repr(params))
