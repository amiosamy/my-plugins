# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/Zekrayat80s
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "Zekrayat80s"

# Entry point
def run():
    plugintools.log("Zekrayat80s.run")
...
def main_list(params):
    plugintools.log("Zekrayat80s.main_list "+repr(params))
