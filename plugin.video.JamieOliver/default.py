# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/JamieOliver
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "JamieOliver"

# Entry point
def run():
    plugintools.log("JamieOliver.run")
...
def main_list(params):
    plugintools.log("JamieOliver.main_list "+repr(params))
