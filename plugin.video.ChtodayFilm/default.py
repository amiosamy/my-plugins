# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/ChtodayFilm
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "ChtodayFilm"

# Entry point
def run():
    plugintools.log("ChtodayFilm.run")
...
def main_list(params):
    plugintools.log("ChtodayFilm.main_list "+repr(params))
