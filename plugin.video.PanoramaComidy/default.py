# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/PanoramaComidy
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "PanoramaComidy"

# Entry point
def run():
    plugintools.log("PanoramaComidy.run")
...
def main_list(params):
    plugintools.log("PanoramaComidy.main_list "+repr(params))
