# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/aljazeeradoc
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "aljazeeradoc"

# Entry point
def run():
    plugintools.log("aljazeeradoc.run")
...
def main_list(params):
    plugintools.log("aljazeeradoc.main_list "+repr(params))
