# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/TaranimArabia
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "TaranimArabia"

# Entry point
def run():
    plugintools.log("TaranimArabia.run")
...
def main_list(params):
    plugintools.log("TaranimArabia.main_list "+repr(params))
