# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/TheSahar76
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "TheSahar76"

# Entry point
def run():
    plugintools.log("TheSahar76.run")
...
def main_list(params):
    plugintools.log("TheSahar76.main_list "+repr(params))
