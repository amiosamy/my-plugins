# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/ComediaArabia
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "ComediaArabia"

# Entry point
def run():
    plugintools.log("ComediaArabia.run")
...
def main_list(params):
    plugintools.log("ComediaArabia.main_list "+repr(params))
