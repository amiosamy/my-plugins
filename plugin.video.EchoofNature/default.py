# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/EchoofNature
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "EchoofNature"

# Entry point
def run():
    plugintools.log("EchoofNature.run")
...
def main_list(params):
    plugintools.log("EchoofNature.main_list "+repr(params))
