# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/CTVegypt
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "CTVegypt"

# Entry point
def run():
    plugintools.log("CTVegypt.run")
...
def main_list(params):
    plugintools.log("CTVegypt.main_list "+repr(params))
