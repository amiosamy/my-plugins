# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/90Commercial
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "90Commercial"

# Entry point
def run():
    plugintools.log("90Commercial.run")
...
def main_list(params):
    plugintools.log("90Commercial.main_list "+repr(params))
