# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/AlahlyTV
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "AlahlyTV"

# Entry point
def run():
    plugintools.log("AlahlyTV.run")
...
def main_list(params):
    plugintools.log("AlahlyTV.main_list "+repr(params))
