# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/rotanaaflaam
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "rotanaaflaam"

# Entry point
def run():
    plugintools.log("rotanaaflaam.run")
...
def main_list(params):
    plugintools.log("rotanaaflaam.main_list "+repr(params))
