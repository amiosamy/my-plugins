# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/radioabana
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "radioabana"

# Entry point
def run():
    plugintools.log("radioabana.run")
...
def main_list(params):
    plugintools.log("radioabana.main_list "+repr(params))
