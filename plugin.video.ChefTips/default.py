# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/ChefTips
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "ChefTips"

# Entry point
def run():
    plugintools.log("ChefTips.run")
...
def main_list(params):
    plugintools.log("ChefTips.main_list "+repr(params))
