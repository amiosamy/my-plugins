# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/albernameg
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "albernameg"

# Entry point
def run():
    plugintools.log("albernameg.run")
...
def main_list(params):
    plugintools.log("albernameg.main_list "+repr(params))
