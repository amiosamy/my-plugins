# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/Cartoonegy1
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "Cartoonegy1"

# Entry point
def run():
    plugintools.log("Cartoonegy1.run")
...
def main_list(params):
    plugintools.log("Cartoonegy1.main_list "+repr(params))
