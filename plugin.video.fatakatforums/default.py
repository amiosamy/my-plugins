# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/fatakatforums
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "fatakatforums"

# Entry point
def run():
    plugintools.log("fatakatforums.run")
...
def main_list(params):
    plugintools.log("fatakatforums.main_list "+repr(params))
