# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/manalalalem
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "manalalalem"

# Entry point
def run():
    plugintools.log("manalalalem.run")
...
def main_list(params):
    plugintools.log("manalalalem.main_list "+repr(params))
