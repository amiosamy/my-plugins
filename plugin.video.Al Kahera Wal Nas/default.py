# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/cairocentric
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "cairocentric"

# Entry point
def run():
    plugintools.log("cairocentric.run")
...
def main_list(params):
    plugintools.log("cairocentric.main_list "+repr(params))
