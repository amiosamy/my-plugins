# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/ChefOsamaElSayed
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "ChefOsamaElSayed"

# Entry point
def run():
    plugintools.log("ChefOsamaElSayed.run")
...
def main_list(params):
    plugintools.log("ChefOsamaElSayed.main_list "+repr(params))
