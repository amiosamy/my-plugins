# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/TheTomEJerryShow
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "TheTomEJerryShow"

# Entry point
def run():
    plugintools.log("TheTomEJerryShow.run")
...
def main_list(params):
    plugintools.log("TheTomEJerryShow.main_list "+repr(params))
