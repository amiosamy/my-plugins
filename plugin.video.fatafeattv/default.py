# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/fatafeattv
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "fatafeattv"

# Entry point
def run():
    plugintools.log("fatafeattv.run")
...
def main_list(params):
    plugintools.log("fatafeattv.main_list "+repr(params))
