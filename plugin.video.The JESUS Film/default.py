# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/jesusfilm
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "jesusfilm"

# Entry point
def run():
    plugintools.log("jesusfilm.run")
...
def main_list(params):
    plugintools.log("jesusfilm.main_list "+repr(params))
