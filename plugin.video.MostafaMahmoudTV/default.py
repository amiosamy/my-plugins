# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/MostafaMahmoudTV
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "MostafaMahmoudTV"

# Entry point
def run():
    plugintools.log("MostafaMahmoudTV.run")
...
def main_list(params):
    plugintools.log("MostafaMahmoudTV.main_list "+repr(params))
