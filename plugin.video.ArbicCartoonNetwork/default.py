# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/ArbicCartoonNetwork
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "ArbicCartoonNetwork"

# Entry point
def run():
    plugintools.log("ArbicCartoonNetwork.run")
...
def main_list(params):
    plugintools.log("ArbicCartoonNetwork.main_list "+repr(params))
