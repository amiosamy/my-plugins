# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/CBNonline
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "CBNonline"

# Entry point
def run():
    plugintools.log("CBNonline.run")
...
def main_list(params):
    plugintools.log("CBNonline.main_list "+repr(params))
