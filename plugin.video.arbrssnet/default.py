# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/arbrssnet
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "arbrssnet"

# Entry point
def run():
    plugintools.log("arbrssnet.run")
...
def main_list(params):
    plugintools.log("arbrssnet.main_list "+repr(params))
