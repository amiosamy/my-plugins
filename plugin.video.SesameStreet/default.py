# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/SesameStreet
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "SesameStreet"

# Entry point
def run():
    plugintools.log("SesameStreet.run")
...
def main_list(params):
    plugintools.log("SesameStreet.main_list "+repr(params))
