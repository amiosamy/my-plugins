# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/ashrafeg
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "ashrafeg"

# Entry point
def run():
    plugintools.log("ashrafeg.run")
...
def main_list(params):
    plugintools.log("ashrafeg.main_list "+repr(params))
