# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/UC7g8fgSI_gBIk8ICAXSefvA
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "UC7g8fgSI_gBIk8ICAXSefvA"

# Entry point
def run():
    plugintools.log("UC7g8fgSI_gBIk8ICAXSefvA.run")
...
def main_list(params):
    plugintools.log("UC7g8fgSI_gBIk8ICAXSefvA.main_list "+repr(params))
