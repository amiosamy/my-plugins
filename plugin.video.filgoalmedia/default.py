# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/filgoalmedia
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "filgoalmedia"

# Entry point
def run():
    plugintools.log("filgoalmedia.run")
...
def main_list(params):
    plugintools.log("filgoalmedia.main_list "+repr(params))
