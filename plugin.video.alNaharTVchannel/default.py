# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/alNaharTVchannel
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "alNaharTVchannel"

# Entry point
def run():
    plugintools.log("alNaharTVchannel.run")
...
def main_list(params):
    plugintools.log("alNaharTVchannel.main_list "+repr(params))
