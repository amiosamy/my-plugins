# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/IICarTooNII
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "IICarTooNII"

# Entry point
def run():
    plugintools.log("IICarTooNII.run")
...
def main_list(params):
    plugintools.log("IICarTooNII.main_list "+repr(params))
