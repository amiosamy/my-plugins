# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/UCur1qVC0iVlKwCJGcJXUNcA
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "UCur1qVC0iVlKwCJGcJXUNcA"

# Entry point
def run():
    plugintools.log("UCur1qVC0iVlKwCJGcJXUNcA.run")
...
def main_list(params):
    plugintools.log("UCur1qVC0iVlKwCJGcJXUNcA.main_list "+repr(params))
