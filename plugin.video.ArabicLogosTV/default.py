# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/ArabicLogosTV
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "ArabicLogosTV"

# Entry point
def run():
    plugintools.log("ArabicLogosTV.run")
...
def main_list(params):
    plugintools.log("ArabicLogosTV.main_list "+repr(params))
