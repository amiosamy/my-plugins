# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/ELBALACONA
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "ELBALACONA"

# Entry point
def run():
    plugintools.log("ELBALACONA.run")
...
def main_list(params):
    plugintools.log("ELBALACONA.main_list "+repr(params))
