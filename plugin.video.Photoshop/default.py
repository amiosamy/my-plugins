# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/Photoshop
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "Photoshop"

# Entry point
def run():
    plugintools.log("Photoshop.run")
...
def main_list(params):
    plugintools.log("Photoshop.main_list "+repr(params))
