# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/MiracleArabic
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "MiracleArabic"

# Entry point
def run():
    plugintools.log("MiracleArabic.run")
...
def main_list(params):
    plugintools.log("MiracleArabic.main_list "+repr(params))
