# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/HanyMinaMikhail
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "HanyMinaMikhail"

# Entry point
def run():
    plugintools.log("HanyMinaMikhail.run")
...
def main_list(params):
    plugintools.log("HanyMinaMikhail.main_list "+repr(params))
