# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/KoraBookoffical2013
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "KoraBookoffical2013"
...
def main_list(params):
    plugintools.log("KoraBookoffical2013.main_list "+repr(params))
