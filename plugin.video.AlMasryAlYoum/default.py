# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/AlMasryAlYoum
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "AlMasryAlYoum"

# Entry point
def run():
    plugintools.log("AlMasryAlYoum.run")
...
def main_list(params):
    plugintools.log("AlMasryAlYoum.main_list "+repr(params))
