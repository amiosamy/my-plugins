# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/owihaNet
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "owihaNet"

# Entry point
def run():
    plugintools.log("owihaNet.run")
...
def main_list(params):
    plugintools.log("owihaNet.main_list "+repr(params))
