# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/Al7ayaAlyoum
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "Al7ayaAlyoum"

# Entry point
def run():
    plugintools.log("Al7ayaAlyoum.run")
...
def main_list(params):
    plugintools.log("Al7ayaAlyoum.main_list "+repr(params))
