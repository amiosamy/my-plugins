# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/DisneyDesenhos
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "DisneyDesenhos"

# Entry point
def run():
    plugintools.log("DisneyDesenhos.run")
...
def main_list(params):
    plugintools.log("DisneyDesenhos.main_list "+repr(params))
