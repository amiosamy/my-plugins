# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/ThePopeshenodaIII
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "ThePopeshenodaIII"

# Entry point
def run():
    plugintools.log("ThePopeshenodaIII.run")
...
def main_list(params):
    plugintools.log("ThePopeshenodaIII.main_list "+repr(params))
