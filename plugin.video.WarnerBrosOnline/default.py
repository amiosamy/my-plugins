# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/WarnerBrosOnline
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "WarnerBrosOnline"

# Entry point
def run():
    plugintools.log("WarnerBrosOnline.run")
...
def main_list(params):
    plugintools.log("WarnerBrosOnline.main_list "+repr(params))
