# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/sunriseagain12
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "sunriseagain12"

# Entry point
def run():
    plugintools.log("sunriseagain12.run")
...
def main_list(params):
    plugintools.log("sunriseagain12.main_list "+repr(params))
